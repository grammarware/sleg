...
'<a href="{}.html">{}</a>',
	'bilink':
'<a href="{0}.html"><strong>{0}</strong></a>',
	'code':
'<code>{}</code>',
# 
	'entry':
'<a class="src" href="{0}">{0}</a>',
# 
	'pub':
'<em><a href="{0}">{1}</a></em>',
# 
	'figure':
'''<div class="fig">
<a href="http://github.com/slebok/sleg/blob/master/figures/{0}"><img
	src="http://github.com/slebok/sleg/raw/master/figures/{0}" alt="{1}" title="{1}"/></a>
<br/>(<a href="http://github.com/slebok/sleg/blob/master/figures/{0}.info.txt">info</a>)</div>''',
# 
	'header':
...
TEMPLATES['indexhead'] = TEMPLATES['header'] % ('','','')
